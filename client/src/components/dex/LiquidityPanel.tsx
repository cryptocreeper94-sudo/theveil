  ...
  return (
    <div className="p-3 rounded-xl bg-slate-950/30 border border-slate-800/40" data-testid="liquidity-panel">
      ...
      <div className="grid gap-2">
        ...
        <button data-testid="add-liquidity" onClick={onAdd} disabled={adding} className="py-3 rounded-md bg-gradient-to-r from-cyan-500 to-sky-500 text-black font-semibold">
